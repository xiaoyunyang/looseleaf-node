  ...
  <div>
    ...
    <div className="row hero section-white center">
      <div className="col s12 m12 l6">
        <img src={getImgPath('landing-plane.png')}/></div>
      <div className="col s12 m12 l6">
    ...
    <div className="section section-green">
      <div className="row text-white">
        ...
        <div className="col s12 m4 l4">
          <div className="col s4 m4 l4">
            <img src={getImgPath('expertise.png')}/>
          </div>
        ...
        <div className="col s12 m4 l4">
          <div className="col s4 m4 l4">
            <img src={getImgPath('cultivate.png')}/>
          </div>
      ...
      <div className="row hero center" style={styles}>
        ...
        <div className="row">
          <div className="col s12 m12 l4">
            <img className="materialboxed" width="650" src="/assets/images/landing/mobile-laptop1.png"/>
          ...
          <div className="col s12 m12 l4">
            <img className="materialboxed" width="650" src="/assets/images/landing/mobile-laptop2.png"/>
            <h4 className="light text-green">Organize</h4>
            <h6 className="light text-brown">Personalize your learning environment.</h6>
            <br/>
          </div>
          <div className="col s12 m12 l4">
            <img className="materialboxed" width="650" src="/assets/images/landing/mobile-laptop3.png"/>
            <h4 className="light text-green">Discover</h4>
            <h6 className="light text-brown">Check out what other people are curating.</h6>
            <br/>
          </div>
        </div>
        <img className="medium-img" src="/assets/images/landing/landing-bookmark.png"/>
      ...
      <div className="row container center">
        ...
        <div className="row text-link-list">
          <div className="col s12 m4 l2">
            <a href="http://looseleafapp.com/dashboard.html#matrix" className="" href="dashboard.html">Entrepreneurs</a>
          </div>
          <div className="col s12 m4 l2">
            <a href="http://looseleafapp.com/dashboard.html#matrix" className="" href="dashboard.html">Teachers</a>
          </div>
          <div className="col s12 m4 l2">
            <a href="http://looseleafapp.com/dashboard.html#matrix" className="" href="dashboard.html">Designers</a>
          </div>
          <div className="col s12 m4 l2">
            <a href="http://looseleafapp.com/dashboard.html#matrix" className="" href="dashboard.html">Developers</a>
          </div>
          <div className="col s12 m4 l2">
            <a href="http://looseleafapp.com/dashboard.html#matrix" className="" href="dashboard.html">Freelancers</a>
          </div>
          <div className="col s12 m4 l2">
            <a href="http://looseleafapp.com/dashboard.html#matrix" className="" href="dashboard.html">Creators</a>
          </div>
        </div>
      </div>
    </div>
