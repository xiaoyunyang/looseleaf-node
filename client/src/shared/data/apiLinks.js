...
export const root = (process.env.NODE_ENV === 'production') ? '' : 'http://localhost:3001';
...
export const apiLink = {
  ...
  notifs: `${root}/api/notif/`,
  userNotifs: (userId, page) => `${root}/api/notif?toUser=${userId}&page=${page}`,
